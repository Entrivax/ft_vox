...
namespace ft_vox.Helpers
{
    ...
    public class HelpShownException : Exception { }
    ...
    public class ArgumentAttribute : Attribute
    {
        ...
        public ArgumentAttribute(string name, string shortName, string helpMessage)
        {
            if (name == null && shortName == null)
                throw new ArgumentException("Name and ShortName cannot be null at the same time");
            if (shortName != null && shortName.Length != 1)
                throw new ArgumentException("ShortName can only be one char length");
            Name = name;
            ShortName = shortName;
